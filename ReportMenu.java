...
public class ReportMenu extends JInternalFrame implements ActionListener
{
 	JLabel  l1;
	JButton b1,b2;
	JPanel p1,p2,p3;
	...
	Connection con;
  	...
  	public ReportMenu()
  	{
		...
		add(p1);
 	 	...
 	 	l1=new JLabel("Menu Item Report");
		l1.setBounds(345,10,150,30);
		l1.setFont(f);
		p1.add(l1);
	...
	void menu()
	{
		try
		{
			String query = "select mcode as 'Menu Item Code',mname as 'Menu Item Name',mtype as 'Menu Item Type',mstatus as 'Menu Item Status',mrate as 'Menu Item Rate' from Menu ";
