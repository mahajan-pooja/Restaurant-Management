...
public class ReportTables extends JInternalFrame implements ActionListener
{
 	JLabel  l1;
	JButton b1,b2;
	JPanel p1,p2,p3;
	...
	void tables()
	{
		try
		{
			String query = "select tno as 'Table No.',occupancy as 'Occupancy' from tables ";
