...
public class ReportRaw extends JInternalFrame implements ActionListener
{
 	JLabel  l1;
	JButton b1,b2;
	JPanel p1,p2,p3;
	...
	void raw()
	{
		try
		{
			String query = "select rcode as 'Raw Item Code',rname as 'Raw Item Name',rtype  as 'Raw Item Type',unitofmeasurement as 'Unit of Measurement' from RI ";
