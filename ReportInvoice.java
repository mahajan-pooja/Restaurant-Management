...
public class ReportInvoice extends JInternalFrame implements ActionListener
{
 	JLabel  l1;
	JButton b1,b2;
	JPanel p1,p2,p3;
	...
	void invoice()
	{
		try
		{
			String query = "select ino as'Invoice No.',grno as 'GRN No.',amount as 'Amount' from invoice1";
