...
public class ReportStock extends JInternalFrame implements ActionListener
{
 	JLabel  l1;
	JButton b1,b2;
	JPanel p1,p2,p3;
	...
	void stock()
	{
		try
		{
			String query = "select rcode as 'Raw Item Code',rname as 'Name',minqty as 'Minimum Qty.',availqty as 'Available Qty.' from Stock ";
