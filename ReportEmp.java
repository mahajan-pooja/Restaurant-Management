...
public class ReportEmp extends JInternalFrame implements ActionListener
{
 	JLabel  l1;
	JButton b1,b2;
	JPanel p1,p2,p3;
	...
	void emp()
	{
		try
		{
			String query = "select empno as 'Employee No.',empname as 'Name',dob as 'Date of Birth',doj as 'Joining Date',contact as 'Contact no.',address as 'Address',emptype as 'Type',salary from employee";
